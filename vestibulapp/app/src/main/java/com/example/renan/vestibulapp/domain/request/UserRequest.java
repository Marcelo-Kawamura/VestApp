package com.example.renan.vestibulapp.domain.request;
...
import com.example.renan.vestibulapp.domain.URLs;
import com.example.renan.vestibulapp.domain.parser.UserParser;
