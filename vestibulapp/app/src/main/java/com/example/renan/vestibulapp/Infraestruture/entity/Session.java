package com.example.renan.vestibulapp.Infraestruture.entity;
...
import com.example.renan.vestibulapp.domain.request.SessionRequest;
...
public class Session  implements SessionRequest.SessionsRequestInterface{
    ...
    public void initSession(String email, String password, Activity activity){
        ...
        SessionRequest.getSessionByCredentials(this, email, password);
