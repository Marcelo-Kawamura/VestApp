...
import com.example.vestibular.vestibulapp.infraestruture.entity.adapter.TopicAdapter;
...
public class TopicsActivity extends BaseActivity implements TopicsRequest.TopicsInterface {
    ...
    @Override
    public void onTopicsResponse(ArrayList<Topics> topicsArrayList)  {
        ...
        listViewTopics.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Topics topic = customAdapter.getItemAtPosition(i);
